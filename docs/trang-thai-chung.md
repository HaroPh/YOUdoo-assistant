...
| 31 | **Lát 5 chạy trên corpus sản xuất** (`20d58d5` + fix `65420d9`, 2026-09-19): SID 117 verified / 104 unverified, 25 lượt VLM ~70k token/tài liệu. CÒN: bảng cột trùng tên (nhóm theo năm) chưa đỡ; `loai=hieu` model gắn nhầm `cong_don` — cần tầng kiểm phép trừ; VLM không tất định giữa lượt; nghiệm thu rộng 4 PDF scan còn lại | chưa ai | ghi chú thi hành |
