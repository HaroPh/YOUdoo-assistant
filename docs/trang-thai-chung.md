...
| 35 | ✅ **ĐÓNG** (`2686310`, merge `c19849f`): `_CHUONG_RE` đòi số/La Mã. Đo trước: 2 lá / 337 chunk bắt nhầm, `Mục` 0 nhầm nên không đụng. Corpus sản xuất CHƯA nạp lại sau sửa — 336 chunk SID còn gốc "Chương trình phần mềm máy tính" tới lần nạp sau | chờ nạp lại | `src/rag/parse.py` |
